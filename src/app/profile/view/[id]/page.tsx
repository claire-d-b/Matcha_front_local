...
const _ = () => {
  // const user_uuid = "0e531c73-6815-4e98-89da-90172af5d324";
        ...
        {form && (
          <div className="w-full flex flex-col md:flex-row items-center justify-center bg-gray-200">
            <Cprofile
              ...
              name={form.firstname ?? "First Name"}
              className="p-1 md:p-8 w-full bg-transparent rounded-lg"
            />
            <div className="w-full p-8 gap-4 flex flex-col justify-center items-center">
              ...
              <Paper className="p-8 rounded-lg flex flex-wrap justify-start items-center gap-4 w-full font-thin">
                <div className="w-full">Interests</div>
                {form.interests &&
                  form.interests.split(",")?.map((h, i) => (
              ...
              <div className="flex flex-col md:flex-row w-full gap-4">
                <Paper className="p-8 rounded-lg flex flex-col gap-4 w-full md:w-1/2 font-thin justify-center items-start">
                  ...
                  <div className="w-full flex justify-start items-center gap-2">
                    <Chip
                      className="self-start bg-gray-700 text-gray-800"
                      label={`${form.age ?? "NA"} y.o.`}
                      variant="filled"
                    />
                    <p className="text-sm font-thin">Target: </p>
                    <Chip
                      label={form.sexual_preferences.toUpperCase()}
                      variant="outlined"
                    />
                  </div>
                </Paper>
                <Paper className="w-full md:w-1/2 rounded-lg">
                  <a
