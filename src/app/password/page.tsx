        ...
        <Paper className="rounded-none h-full p-2 flex flex-col flex-grow flex-shrink-0 justify-center items-center text-lg font-thin">
          ...
          >
            ...
            <div className="w-full flex flex-col justify-center items-center gap-2">
              <div className="w-full md:w-1/4 text-base font-medium">
                Username
              </div>
              ...
              <div className="text-base w-full md:w-1/4">
                We will send an email to this address whith a link to reset your
                password.
              </div>
            </div>
            <Button
