                ...
                <div className="h-full w-full p-12">
                    {
                        <div className="flex flex-col gap-8">
                            <Cstepper />
                            <div className="w-full flex flex-col items-center justify-center bg-gray-800 rounded-lg p-6">
                                ...
                                <div className="p-8 font-thin flex flex-col w-full justify-center items-start gap-4">
                                    ...
                                    <div className="p-8 flex flex-col gap-4 w-full font-thin justify-center items-start">
                                        ...
                                        {/* <Ctextfield opts="w-full p-4 text-sm" type="text" size="small" variant="outlined" multiline={true} rows={6} value={objective} onChange={handleObjective} /> */}
