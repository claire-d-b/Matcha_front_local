        ...
        <ThemeProvider theme={theme}>
            <div className="flex flex-col">
                <div className="w-full flex flex-col items-center justify-center bg-gray-200 rounded-lg">
                    <Cprofile imagePath="../../../images/people_f.png" name='editable' className="w-full p-1 md:p-8 bg-transparent rounded-lg" edit={true} />
                    <div className="w-full p-8 gap-4 flex flex-col justify-center items-center">
                            <Paper className="p-8 rounded-lg flex flex-col gap-4 w-full text-lg font-thin">
                                ...
                                <Stack direction="row" spacing={1}>
                                    <Ctextfield opts="" type="text" size="small" variant="outlined" label="Language" value={language} multiline={false} onChange={handleLanguageChange} disabled={false} />
                                    <Ctextfield opts="" type="text" size="small" variant="outlined" label="City" value={city} multiline={false} onChange={handleCityChange} disabled={false} />
                                </Stack>
                            </Paper>
                        <Paper className="p-8 rounded-lg text-lg font-thin flex flex-col w-full justify-center items-between gap-4">
                            ...
                            <div className="flex flex-col justify-center items-start">
                                ...
                                <Ctextfield opts="w-full self-start font-thin" type="text" size="small" variant="outlined" label={'Interest'} value={hobby} multiline={false} onChange={handleHobby} />
                                ...
                                <IconButton className="self-end bg-gray-800" size="small" onClick={addHobbies}>
                                    <AddIcon />
                                </IconButton>
                            </div>
                        </Paper>
                        <div className="flex flex-col md:flex-row w-full gap-4">
                            <Paper className="w-1/2 p-8 rounded-lg flex flex-col gap-4 w-full font-thin justify-center items-start">
                                ...
                                <div className="w-full flex justify-start items-center gap-2">
                                    <Ctextfield opts="self-start" type="text" size="small" variant="outlined" label={'Age'} value={age} multiline={false} onChange={handleAge} />
                                    <Cselect className="w-full" name="Gender" list={lst} variant="outlined" />
                                </div>
                            </Paper>
                            <Paper className="w-1/2 rounded-lg"><a href="/profile/picture/" className="p-8 flex w-full font-thin text-md justify-center items-start">Click here to see your pictures</a></Paper>
                        </div>
                        <Button className="self-end" variant="contained">Save</Button>
                    </div>
                </div>
            </div>
        </ThemeProvider>
