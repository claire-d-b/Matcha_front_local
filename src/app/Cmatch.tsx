...
const pictures = [
  [],
  ["../../images/people_m.png", "At the sea"],
  ["../../images/people_f.png", "Home"],
  ["../../images/people_m.png", "Birthday snapshot"],
  ["../../images/people_f.png", "New tee-shirt"],
  ["../../images/people_m.png", "<3<3"],
];
...
const _: React.FC<ComponentProps> = ({ className, upload }) => {
      ...
      <div className="w-full h-full flex flex-col justify-center items-center">
        <div className="w-full h-full">
          <Grid
            container
            spacing={4}
            className="flex flex-col w-full h-full justify-center items-center p-8 gap-2"
          >
            {picture.length && (
                        ...
                        <CardActionArea className="m-0 p-4 border rounded-lg shadow-lg">
                          <div className="w-full text-right mb-2 mt-4">
                            <IconButton
                              ...
                              size="small"
                              onClick={(_) => handleDelete(_, index)}
                            >
        ...
        <Pagination
          ...
          className="p-4 md:p-12 self-center text-xs"
        />
      </div>
    </div>
  );
