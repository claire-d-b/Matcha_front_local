                ...
                <div key={`conversation_${i}`}>
                  {(c.messages.length && (
                    <div className="flex gap-1 mb-8 md:mb-4 text-sm justify-center items-center bg-gray-800 rounded-lg p-4">
                      ...
                      >
                        {(c.currentUser ===
                          c.messages[c.messages.length - 1].author && (
                          <div className="w-full flex gap-4 justify-between items-center">
                            <Avatar className="text-xs md:text-xl md:pt-1">
                              {c.otherUser[0].toUpperCase()}
                            </Avatar>
                            <Paper
                              sx={{ backgroundColor: "#35bd63" }}
                          ...
                          <div className="w-full flex justify-start items-center gap-4">
                            ...
                            <Paper className="py-1 px-2 md:px-4 md:py-2 rounded-lg text-xs text-white font-normal bg-gray-400 bg-opacity-50">
                              {c.otherUser} :{" "}
                    ...
                    <div className="flex gap-1 mb-8 md:mb-4 text-sm justify-center items-center bg-gray-800 rounded-lg p-4">
                      <div className="flex w-full justify-start items-center">
                        <Avatar className="flex self-start justify-center items-center text-xs md:text-xl md:pt-1">
                          {c.otherUser[0].toUpperCase()}
                        </Avatar>
                        <div className="py-1 px-2 md:px-4 md:py-2 text-xs text-white font-thin">
                          Conversation created on {c.createdAt}.
                        </div>
                      </div>
                    </div>
                  )}
